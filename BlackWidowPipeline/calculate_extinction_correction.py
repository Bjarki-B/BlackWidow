...
def calc_extinction_correction(Halpha_map : np.ndarray, Hbeta_map : np.ndarray, wavelength : float) -> np.ndarray:
    ...
    -------
    np.ndarray
        The extinction correction map at the specified wavelength. The output 
        will have the same shape as the input maps.
    """
